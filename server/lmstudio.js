...
---
> 🏛️ **الاعتماد الرقمي:** تم إصدار هذا التقرير وتدقيقه آلياً عبر منظومة OSS للذكاء الاصطناعي السيادي (الجمهورية العربية السورية).`;
...
| :---: | :---: |
| *(خاتم منظومة OSS السيادية)* | *(معتمد رقمياً)* |
...
💡 *يمكنك تصدير هذا الجدول تلقائياً بالضغط على زر **"تصدير إلى CSV"** في أعلى الجدول، أو حفظ الصفحة كاملة عبر **"تصدير PDF (طباعة)"**.*`;
    ...
    response = `أهلاً بك في **منظومة OSS للذكاء الاصطناعي السيادي** (الجمهورية العربية السورية).
