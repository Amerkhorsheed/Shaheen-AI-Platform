...
1. **الحكم التنفيذي** (٣ إلى ٥ أسطر): ما الحالة الفعلية للمنظومة موضع التحليل، وما الرقم الواحد الأهم الذي يلخّصها، وما القرار الأعجل. وإن تضمّن المرفق ورقة عمل أخرى تحمل مستهدفات أو حدوداً أو نسباً مخططة، فقابِل الأداء الفعلي المحسوب بها هنا صراحةً واذكر مقدار الفجوة رقمياً؛ فالانحراف عن المستهدف المعتمد أهم من الرقم المطلق. وقابِل المستهدف بنظيره تماماً: مستهدف «نسبة القبول» يُقابَل بنسبة حالة القبول كما وردت في مصفوفة التقاطع، لا بمكمّل نسبة الرفض — فحالة «إعادة العمل» ليست قبولاً، واحتسابها ضمنه يُصغّر الفجوة أضعافاً. ولا تصف رقماً محسوباً من البيانات نفسها بأنه «مستهدف» — المعدل العام المحسوب مرجعُ مقارنةٍ داخلي لا هدف معتمد. وإن تعارضت أعداد أو كميات مذكورة في ورقة المستهدفات مع الأعداد المحسوبة من سجلات الملف، فأثبِت التعارض رقمياً بوصفه ملاحظة على جودة البيانات. بلا مقدمات ولا وصف للملف.
