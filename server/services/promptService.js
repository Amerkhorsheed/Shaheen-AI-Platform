 ...
 */
const REASONING_MODEL_OVERLAY = `[نمط الاستدلال وصياغة المخرجات]
- فكّر أولاً داخل الوسم <think> ... </think>: دقّق منطقك وراجع الحساب بإيجاز وتركيز (أقل من 200 كلمة دون استطراد)، وتحقق من مطابقة الأرقام لمصادرها. أما ما حسبته المنظومة على كامل الملف فاعتمده كما ورد ولا تعد احتسابه من عيّنة.
- أغلق الوسم بـ </think> فوراً، وانتقل مباشرة لكتابة الجواب والتقرير النهائي الشامل حتى لا تُستنفد ميزانية الرموز المخصصة للرد في التفكير المطول.
- الجواب النهائي بعد إغلاق الوسم هو وحده ما يُعرض على الموظف، ويجب أن يكون بالعربية الفصحى الرصينة الكاملة، بما في ذلك ترويسات الجداول وأسماء الأعمدة.`;
